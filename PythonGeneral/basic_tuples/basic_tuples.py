#!/usr/bin/python
# ----------------------------------------------------------
"""Program showing the basic use of tuples"""
...
print(
"""
   The use of TUPLES is very similar to LIST, one difference is in syntax:
   TUPLE use "(...)" and LIST use "[...]"
   but the main difference is that a TUPLE is immutable		 
""")
